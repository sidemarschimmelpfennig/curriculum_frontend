<template>
  <div
    class="max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center"
  >
    <h1
      class="text-xl font-bold text-center text-gray-700 dark:text-gray-200 mb-8"
    >
    ...
    <form action="#" class="w-full flex flex-col gap-4">
      ...
      <div class="flex items-start flex-col justify-start">
        <label for="email" class="text-sm text-gray-700 dark:text-gray-200 mr-2"
          >Email:</label
        >
        <input
          type="email"
      ...
      <select
        ...
        class="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
      >
        <option value="Gender">Defina seu gênero</option>
        <option id="Men">Homem</option>
        <option id="Woman">Mulher</option>
        <option id="Undefined">Não me identificar</option>
        <option id="Other">Outros...</option>
      </select>
